...
var Products = /** @class */ (function () {
    ...
    function Products() {
        ...
        this.logo = protractor_1.element(protractor_1.by.xpath("//div[contains(@class,'app_logo')]"));
        this.headerProducts = protractor_1.element(protractor_1.by.xpath("//div[@class='product_label'][contains(.,'Products')]"));
        this.addToCart = protractor_1.element(protractor_1.by.xpath("(//button[@class='btn_primary btn_inventory'][contains(.,'ADD TO CART')])[1]"));
        this.removeCart = protractor_1.element(protractor_1.by.xpath("//button[@class='btn_secondary btn_inventory'][contains(.,'REMOVE')]"));
        this.shoppingCartBadge = protractor_1.element(protractor_1.by.xpath("//span[@class='fa-layers-counter shopping_cart_badge'][contains(.,'1')]"));
    }
    Products.prototype.loginBtnClick = function () {
    ...
    Products.prototype.addToCartClick = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, protractor_1.browser.wait(this.EK.elementToBeClickable(this.addToCart), this.timeForWait, 'На екрана се очакваше да има предмет"' + this.addToCart + '", но го няма!')];
                    case 1:
                        _a.sent();
    ...
    Products.prototype.adultsUpBtnClick = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Products.prototype.childUpBtnClick = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Products.prototype.childDownBtnClick = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Products.prototype.passwordTxt = function (d) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, protractor_1.browser.wait(this.EK.visibilityOf(this.password), this.timeForWait, 'На екрана се очакваше да има предмет"' + this.password + '", но го няма!')];
                    case 1:
                        _a.sent();
    ...
    Products.prototype.destinationDDL = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
