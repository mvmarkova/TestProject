        ...
        it('Test 1 - попълване коректни данни; ', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        _a.apply(void 0, [_b.sent()]).toEqual(data.header);
                    ...
                    case 12:
                        _b.sent();
                        return [4 /*yield*/, protractor_1.browser.wait(EK.visibilityOf(yourMessege), 5000, 'На екрана се очакваше да има съобщние "' + yourMessege + '", но го няма!')];
                    case 13:
                        _b.sent();
                    ...
                    case 17:
                        _b.sent();
                        return [4 /*yield*/, protractor_1.browser.wait(EK.visibilityOf(notValidEmail), 10000, 'На екрана се очакваше да има съобщение "' + notValidEmail + '", но го няма!')];
                    case 18:
                        _b.sent();
                        return [4 /*yield*/, protractor_1.browser.sleep(5000)];
                    case 19:
    ...
    it('Test 1 - попълване коректни данни; ', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 17:
                    _b.sent();
                    return [4 /*yield*/, tel.sendKeys('676767')];
                case 18:
                    _b.sent();
                    return [4 /*yield*/, protractor_1.browser.sleep(5000)];
                case 19:
