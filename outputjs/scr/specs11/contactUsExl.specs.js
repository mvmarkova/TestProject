        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, protractor_1.browser.get('')];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
        ...
        fit('Test 1 - попълване коректни данни; ', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 3:
                        _h.sent(); // за време изаква да се появи заглавието.
                        _b = (_a = console).log;
                        _c = '///';
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, header.getText()];
                    case 5:
                        _d.apply(void 0, [_h.sent()]).toEqual(data.header);
