...
/**
 *  Class contains locators and methods (Page Object Model(POM))
 */
...
var Login = /** @class */ (function () {
    ...
    Login.prototype.contructor = function () {
        ...
        this.notValidEmailAndPassword = protractor_1.element(protractor_1.by.xpath("//h3[@data-test='error'][contains(.,'Epic sadface: Username and password do not match any user in this service')]")); // заглавие на съобщението за грешен username и password 
    };
    Login.prototype.loginBtnClick = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, protractor_1.browser.wait(this.EK.elementToBeClickable(this.loginBtn), this.timeForWait, 'На екрана се очакваше да има предмет"' + this.loginBtn + '", но го няма!')];
                    case 1:
                        _a.sent();
    ...
    Login.prototype.usernameTxt = function (d) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Login.prototype.passwordTxt = function (d) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: // метода се използва от няколко текстови полета 
                    return [4 /*yield*/, protractor_1.browser.wait(this.EK.visibilityOf(this.password), this.timeForWait, 'На екрана се очакваше да има име "' + this.password + '", но го няма!')];
                    case 1:
                        _a.sent();
