...
var Login = /** @class */ (function () {
    ...
    Login.prototype.myPrice = function (d, e) {
        return __awaiter(this, void 0, void 0, function () {
            var err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 7:
                        err_3 = _a.sent();
                        console.log("////" + "error in login.po.myTxtBox() " + err_3);
                        expect(true).toBe(false, "////" + "error in login.po.myTxtBox() " + err_3);
                        return [3 /*break*/, 8];
                    case 8: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        err_4 = _a.sent();
                        console.log("///" + "====== error in login.po.myLogin() " + err_4);
                        expect(true).toBe(false, "////" + "=======error in login.po.myLogin() " + err_4);
                        return [3 /*break*/, 5];
