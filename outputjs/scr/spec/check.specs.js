...
//import { Check } from '../po/check.po';
var products_po_1 = require("../po/products.po");
//import { Products } from '../po/check.po';
...
describe('Екран за контакти - това е ТестСуит', function () {
    ...
    beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, myProducts.myProducts()];
                case 4:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('Подаване на тестови данни от екселски файл всеки ред е отделен тест случай; ', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            console.log("////");
            return [2 /*return*/];
        });
