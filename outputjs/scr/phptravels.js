...
describe('Екран за контакти - това е ТестСуит', function () {
    ...
    fit('Test 1 - Резервация на хотел с некоректни данни; ', function () { return __awaiter(_this, void 0, void 0, function () {
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    _c.sent();
                    return [4 /*yield*/, protractor_1.browser.wait(EK.visibilityOf(destinationHeader), 5000, 'На екрана се очакваше да има Заглавие "' + destinationHeader + '", но го няма!')];
                case 2:
                ...
                case 5:
                    _c.sent();
                    return [4 /*yield*/, protractor_1.browser.wait(EK.visibilityOf(destination), 5000, 'На екрана се очакваше да има e-mail "' + destination + '", но го няма!')];
                case 6:
                    _c.sent();
                ...
                case 9:
                    _c.sent();
                    return [4 /*yield*/, protractor_1.browser.wait(EK.visibilityOf(noMatchesFound), 5000, 'На екрана се очакваше да има e-mail "' + noMatchesFound + '", но го няма!')];
                case 10:
                    _c.sent();
                    _b = expect;
    ...
    it('Test 1 - Резервация на хотел с коректни данни; ', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 7:
                    _c.sent();
                    return [4 /*yield*/, protractor_1.browser.wait(EK.visibilityOf(destinationValue), 5000, 'На екрана се очакваше да се разлисти списъка с хотели "' + destinationValue + '", но го няма!')];
                case 8:
                    _c.sent();
                ...
                case 9:
                    ...
                    return [4 /*yield*/, protractor_1.browser.wait(EK.visibilityOf(checkInHeader), 5000, 'На екрана се очакваше да има Заглавие "' + checkInHeader + '", но го няма!')];
                case 10:
                    // await  browser.sleep(5000);  
                    _c.sent(); // за време изаква да се появи заглавието.
                    _b = expect;
                ...
                case 11:
                    _b.apply(void 0, [_c.sent()]).toEqual('CHECK IN');
                    // await browser.sleep(5000);
                    return [4 /*yield*/, protractor_1.browser.wait(EK.visibilityOf(checkIn), 5000, 'На екрана се очакваше да има име "' + checkIn + '", но го няма!')];
                case 12:
                    // await browser.sleep(5000);
                    _c.sent();
                ...
                case 16:
                    _c.sent();
                    return [4 /*yield*/, protractor_1.browser.wait(EK.visibilityOf(checkOut), 5000, 'На екрана се очакваше да има предмет"' + checkOut + '", но го няма!')];
                case 17:
                    _c.sent();
                ...
                case 21:
                    _c.sent();
                    return [4 /*yield*/, protractor_1.browser.wait(EK.visibilityOf(adultsDownBtn), 5000, 'На екрана се очакваше да има предмет "' + adultsDownBtn + '", но го няма!')];
                case 22:
                    _c.sent();
                ...
                case 24:
                    _c.sent();
                    return [4 /*yield*/, protractor_1.browser.wait(EK.visibilityOf(adultsUpBtn), 5000, 'На екрана се очакваше да има телефон "' + adultsUpBtn + '", но го няма!')];
                case 25:
                    _c.sent();
                ...
                case 31:
                    _c.sent();
                    //await browser.sleep(5000);
                    return [4 /*yield*/, protractor_1.browser.wait(EK.visibilityOf(searchBtn), 5000, 'На екрана се очакваше да има телефон "' + searchBtn + '", но го няма!')];
                case 32:
                    //await browser.sleep(5000);
                    _c.sent();
    ...
    it('Test 1 - попълване коректни данни; ', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 5:
                    _b.sent();
                    return [4 /*yield*/, destination.sendKeys('Plovdiv')];
                case 6:
                    _b.sent();
                    return [4 /*yield*/, protractor_1.browser.sleep(5000)];
                case 7:
                ...
                case 9:
                    _b.sent();
                    return [4 /*yield*/, subject.sendKeys('програмен продукт')];
                case 10:
                    _b.sent();
                    return [4 /*yield*/, protractor_1.browser.sleep(5000)];
                case 11:
