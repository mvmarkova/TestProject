...
var protractor_1 = require("protractor"); // add library for protractor 
/**
 * every description is suit for many 'it' - test cases
 */
describe('Test of https://www.phptravels.net/home', function () {
    ...
    hotelHeading = protractor_1.element(protractor_1.by.xpath("//span[@class='text-primary'][contains(.,'alzer-hotel-istanbuls')]"));
    var EK = protractor_1.protractor.ExpectedConditions;
    var timeForWait = 5000; // time for expected conditional 
    /**
    ...
    it('Test 1 - Резервация на хотел с некоректни данни; ', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: //async /await - use in test of ajax pages  
                return [4 /*yield*/, protractor_1.browser.wait(EK.visibilityOf(destinationHeader), timeForWait, 'Expected headings"' + destinationHeader + '", but is not!')];
                case 1:
                    _c.sent(); // wait  expected conditional for chech of new window
                    _a = expect;
                ...
                case 5:
                    _c.sent();
                    return [4 /*yield*/, protractor_1.browser.wait(EK.visibilityOf(noMatchesFound), timeForWait, 'Expected response output"' + noMatchesFound + '", but is not!')];
                case 6:
                    _c.sent();
                    _b = expect;
    ...
    it('Test 2 - Резервация на хотел с коректни данни; ', function () { return __awaiter(_this, void 0, void 0, function () {
        var _a, _b, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0: return [4 /*yield*/, protractor_1.browser.wait(EK.visibilityOf(destinationHeader), timeForWait, 'Expected headings "' + destinationHeader + '", but is not!')];
                case 1:
                ...
                case 4:
                    _d.sent();
                    return [4 /*yield*/, protractor_1.browser.wait(EK.visibilityOf(destinationValue), timeForWait, 'Expected option to be clicked "' + destinationValue + '", but is not!')];
                case 5:
                    _d.sent();
                    return [4 /*yield*/, destinationValue.click()];
                case 6:
                    _d.sent();
                    return [4 /*yield*/, protractor_1.browser.wait(EK.elementToBeClickable(checkInHeader), timeForWait, 'Expected heading "' + checkInHeader + '", but is not!')];
                case 7:
                    _d.sent(); // за време изаква да се появи заглавието.
                    _b = expect;
                ...
                case 8:
                    ...
                    return [4 /*yield*/, protractor_1.browser.wait(EK.visibilityOf(checkIn), timeForWait, 'Expected check in date "' + checkIn + '", but in not!')];
                case 9:
                    _d.sent();
                ...
                case 13:
                    _d.sent();
                    return [4 /*yield*/, protractor_1.browser.wait(EK.visibilityOf(checkOut), timeForWait, 'Expected check out date"' + checkOut + '", but is not!')];
                case 14:
                    _d.sent();
                ...
                case 17:
                    _d.sent();
                    return [4 /*yield*/, protractor_1.browser.wait(EK.elementToBeClickable(adultsDownBtn), timeForWait, 'Expected button to be clicked "' + adultsDownBtn + '", but is not!')];
                case 18:
                    _d.sent();
                    return [4 /*yield*/, adultsDownBtn.click()];
                case 19:
                    _d.sent();
                    return [4 /*yield*/, protractor_1.browser.wait(EK.elementToBeClickable(adultsUpBtn), timeForWait, 'Expected button to be clicked "' + adultsUpBtn + '", but is not!')];
                case 20:
                    _d.sent();
                    return [4 /*yield*/, adultsUpBtn.click()];
                case 21:
                    _d.sent();
                    return [4 /*yield*/, protractor_1.browser.wait(EK.elementToBeClickable(childDownBtn), timeForWait, 'Expected button to be clicked "' + childDownBtn + '", but is not!')];
                case 22:
                    _d.sent();
                    return [4 /*yield*/, childDownBtn.click()];
                case 23:
                    _d.sent();
                    return [4 /*yield*/, protractor_1.browser.wait(EK.elementToBeClickable(childUpBtn), timeForWait, ' Expected button to be clicked "' + childUpBtn + '", but is not!')];
                case 24:
                    _d.sent();
                    return [4 /*yield*/, childUpBtn.click()];
                case 25:
                    _d.sent();
                    return [4 /*yield*/, protractor_1.browser.wait(EK.elementToBeClickable(searchBtn), timeForWait, 'Expected button to be clicked"' + searchBtn + '", but is not!')];
                case 26:
                    _d.sent();
