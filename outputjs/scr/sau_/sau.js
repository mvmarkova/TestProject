...
describe('Екран за контакти - това е ТестСуит', function () {
    var PossitiveAndNegativeTest = xl.readFromExcel('PossitiveAndNegativeTest', './dataFiles/contactUs.xlsx');
    var contactUsBtn;
    var header;
    var email;
    var name;
    ...
    it('Test 1 - попълване коректни данни; ', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.sent();
                    return [4 /*yield*/, protractor_1.browser.wait(EK.visibilityOf(username), timeForWait, 'На екрана се очакваше да има e-mail "' + username + '", но го няма!')];
                case 2:
                    _b.sent();
                ...
                case 6:
                    _b.sent();
                    return [4 /*yield*/, protractor_1.browser.wait(EK.visibilityOf(loginBtn), timeForWait, 'На екрана се очакваше да има e-mail "' + loginBtn + '", но го няма!')];
                case 7:
                    _b.sent();
                    return [4 /*yield*/, loginBtn.click()];
                case 8:
                ...
                case 10:
                    _a.apply(void 0, [_b.sent()]).toContain('Epic sadface: Password is required');
                    return [4 /*yield*/, protractor_1.browser.sleep(5000)];
                case 11:
                    _b.sent();
                    return [2 /*return*/];
    ...
    it('Test 1 - попълване коректни данни; ', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 6:
                    _b.sent();
                    return [4 /*yield*/, protractor_1.browser.wait(EK.visibilityOf(lockedUser), timeForWait, 'На екрана се очакваше да има e-mail "' + lockedUser + '", но го няма!')];
                case 7:
                    _b.sent();
                    _a = expect;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 6:
                    ...
                    return [4 /*yield*/, protractor_1.browser.getCurrentUrl()];
                case 7:
                    _a.apply(void 0, [_b.sent()]).toContain("saucedemo.com/");
                    return [2 /*return*/];
            }
        });
    }); });
